...
Existing installs can update from **System → Update → Extensions → Find Updates**.

## Documentation

Full guides — installation, settings, per-article SEO, title templates and social
cards — are at <https://vpjoomla.com/docs/extensions-docs/vp-seo>.
